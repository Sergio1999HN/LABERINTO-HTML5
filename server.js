...
// Servir archivos estáticos desde la subcarpeta JUEGOS-HTML5
app.use(express.static(path.join(__dirname, 'JUEGOS-HTML5')));

// Responder con index.html para cualquier ruta (SPA)
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'JUEGOS-HTML5', 'index.html'));
});
